...
@Autonomous
public class GoodAutoBlueWarehouse extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        highGoal = drive.trajectorySequenceBuilder(blueStartPoseWarehouse)
                .strafeRight(23.75)
                .forward(22)
                .build();
        highGoal2 = drive.trajectorySequenceBuilder(new Pose2d(-11.75,41.25, Math.toRadians(-90)))
                ...
                .forward(48)
                .build();
        midGoal = drive.trajectorySequenceBuilder(blueStartPoseWarehouse)
                .strafeRight(23.75)
                .forward(17)
                .build();
        midGoal2 = drive.trajectorySequenceBuilder(new Pose2d(-11.75,46.25, Math.toRadians(-90)))
                .lineToSplineHeading(new Pose2d(12, 52, Math.toRadians(0)))
                .forward(48)
                .build();
        lowGoal = drive.trajectorySequenceBuilder(blueStartPoseWarehouse)
                .strafeRight(23.75)
                .forward(14.5)
                .addTemporalMarker(0, () -> {
                    door.setPosition(0);
        ...
        switch (element_position) {
            case LEFT: {
                // low
                drive.setPoseEstimate(blueStartPoseWarehouse);
    ...
    public static class TestPipeline extends OpenCvPipeline {
        ...
        Point Center1 = new Point(400, 520);
